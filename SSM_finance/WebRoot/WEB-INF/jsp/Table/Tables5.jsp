			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">资产信息管理</h3>
						</div>
							<div class="panel-body">
								...
								<tbody>
									<c:forEach items="${assetsinformation}" var="as">
									<tr>
									<td>${as.id }</td>
									<td>${as.name }</td>
									<td>${as.assetsname }</td>
									<td>
									<fmt:formatDate value="${as.creatdate}" pattern="yyyy-MM-dd HH:mm:ss"/>
									</td>
									<td>
									<fmt:formatDate value="${as.modifydate}" pattern="yyyy-MM-dd HH:mm:ss"/>
									</td>
									<td>
...
<script src="${pageContext.request.contextPath }/statics/assets/js/Table_js/table5.js"></script>
